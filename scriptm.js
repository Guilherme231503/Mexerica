...
function filterOptionsByModel() {
    ...
    if (modelType == "promax") {
        ConfigureText.textContent = "Configure seu Mexerica Phone 15 Plus";
    } else if(modelType == "pro") {
        ConfigureText.textContent = "Configure seu Mexerica Phone 15";
    }
    if (modelType !== "promax") {
...
$('#add-to-cart').on('click', function() {
   ...
   if(selectedModel == 'pro') {
       modeling = 'MexericaPhone 15';
   } else if(selectedModel == 'promax') {
       modeling = 'MexericaPhone 15 Plus';
   } 
